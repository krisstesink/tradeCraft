package idkhi.tradecraft.block.custom;

import idkhi.tradecraft.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.GEM_POLISHING_STATION_BLOCK_ENTITY, (world1, pos, state1, be) -> GemPolishingStationBlockEntity.tick(world1, pos, state1, (GemPolishingStationBlockEntity) be));
    }
}
